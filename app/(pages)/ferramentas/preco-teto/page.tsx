        ...
        <Card>
          <CardContent className="flex gap-3 items-center text-muted-foreground">
            ...
            <p>
              ...
              ação estimado. O resultado será o preço teto, ou seja, preço
              máximo que poderá comprar um ativo para atingir o dividend yield
              desejado.{" "}
              <Dialog>
                ...
                <DialogContent className="min-w-2xl max-md:min-w-[90%] max-h-[90%] overflow-auto">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      ...
                      <strong>preço máximo</strong> que deve pagar por um ativo
                      para atingir o <strong>dividend yield desejado</strong>. É
                      especialmente útil para investidores focados em renda
                      passiva, que querem planejar compras de ações ou FIIs com
                      base em dividendos.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                      ...
                      <li>
                        <strong>Dividend Yield desejado:</strong> a taxa mínima
                        de retorno em dividendos que você espera obter.
                      </li>
                      <li>
                        <strong>Dividendo por ação estimado:</strong> o valor
                        esperado de dividendos distribuídos por ação no ano.
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                      <li>
                        Definir preços de entrada consistentes com sua
                        estratégia de dividendos.
                      </li>
                      <li>
                        Evitar pagar acima do valor que garante o retorno
                        desejado em dividendos.
                      </li>
                      <li>
                        Comparar diferentes ativos ou FIIs antes de decidir a
                        compra.
                      </li>
                    </ul>
                    ...
                    <ul className="list-disc ml-5 space-y-1">
                      <li>
                        Use uma estimativa de dividendos recorrentes, evitando
                        incluir pagamentos extraordinários.
                      </li>
                      <li>
                        Defina um dividend yield mínimo realista de acordo com o
                        risco do ativo.
                      </li>
                      <li>
                        Combine essa análise com outros indicadores e não baseie
                        toda a decisão apenas no preço teto.
                      </li>
                      <li>
                        Reavalie periodicamente os dividendos esperados e o
                        preço teto, pois ambos podem mudar com o tempo.
                      </li>
                    </ul>
                  </div>
                </DialogContent>
